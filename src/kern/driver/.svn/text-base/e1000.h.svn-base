...
#define E1000_ERR(args...) cprintf("e1000: " args)

#ifdef E1000_DEBUG
#define E1000_DBG(args...)	cprintf("e1000: " args)
#define DEBUGOUT(fmt,args...) cprintf(fmt ,##args)
#define DEBUGFUNC()        cprintf("%s\n", __FUNCTION__);
#else
...
#define E1000_DEV_ID_82540EM        0x100E      // this is what I used for ucore
